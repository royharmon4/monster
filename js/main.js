...
function createSnarlMouth(rng, p){
...
function spawnImpactLines(){
  ...
  el.style.left = `${cx}px`;
  el.style.top  = `${cy}px`;
  // Draw 10 radiating lines as an inline SVG
...
function flinchMonster(){
  ...
  // Temporarily swap eyes to flinch state
...
function playDeathSequence(kid){
  ...
  // 1. Pre-death squash before X-eyes swap
  if(svg){
